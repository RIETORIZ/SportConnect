...
class _TrainingPageState extends State<TrainingPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('Training Sessions', style: TextStyle(color: Colors.greenAccent)),
        backgroundColor: Colors.black,
      ...
      body: Padding(
        ...
        child: Column(
          children: [
            ...
            if (upcoming.isNotEmpty && previous.isNotEmpty) const SizedBox(height: 20),
            ...
            if (upcoming.isEmpty && previous.isEmpty)
              const Expanded(
                child: Center(
                  child: Text('No training sessions found.', style: TextStyle(color: Colors.white)),
                ),
              ),
          ],
        ),
